        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="text-center p-6 bg-white rounded-xl shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl hover:scale-105"
            >
              <div
                ref={index < 3 ? undefined : undefined}
