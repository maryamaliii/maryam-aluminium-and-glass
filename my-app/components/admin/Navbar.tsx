  ...
  return (
    <header className="sticky top-0 z-30 bg-gray-900/80 backdrop-blur-md border-b border-gray-800">
      <div className="flex items-center justify-between px-4 h-16">
        <button onClick={onMenuToggle} className="text-gray-400 hover:text-white lg:hidden p-2 min-h-[44px] min-w-[44px] flex items-center justify-center">
          <MdMenu size={24} />
        </button>
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-2.5 sm:py-2 rounded-lg text-sm text-gray-300 hover:text-white hover:bg-gray-800 transition min-h-[44px] sm:min-h-0"
          >
            <MdPerson size={20} />
